#Creates a new compute engine instance and uses it to apply a caption to an image.
...
def create_instance(compute, project, zone, name, bucket):
    ...
    config = {
        ...
        'serviceAccounts': [{'email': 'default','scopes': ['https://www.googleapis.com/auth/devstorage.read_write','https://www.googleapis.com/auth/logging.write']}],
